...
public:
 ~Network();
   ...
   * @return Responce.
   */
  std::string request(std::string_view body, const dictionary& params) const noexcept;
  /*!
   * @brief Download file from <em><b>server</b></em> to <em><b>filename</b></em>.
   * @return <em><b>0</b></em> on success, <em><b>-1</b></em> otherwise.
   */
  std::size_t download(std::string_view filename, std::string_view server) const noexcept;
  /*!
   * @brief Upload file to <em><b>server</b></em> from <em><b>filename</b></em>.
   * @return Responce.
   */
  std::string upload(std::string_view filename, std::string_view server) const noexcept;
  /*!
   ...
   * @return Responce.
   */
  std::string requestdata(std::string_view body, std::string_view data) const noexcept;
};
}
